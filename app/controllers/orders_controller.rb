class OrdersController < ApplicationController
  before_action :set_orders, only: %I[destroy add_unit reduce_unit]
  ...
  # me advise: add a condition to redirect if
  # the Product.find(params[:product_id]) exists - that means that you are in the show page!!
